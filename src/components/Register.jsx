    ...
    createUserWithEmailAndPassword(auth, user.email, user.password)
      .then((userCredential) => {
        ...
        updateProfile(auth.currentUser, {
          displayName:user.username, photoURL: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
        }).then((res) => {
          // Profile updated!
          console.log(res);
